...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(               //to use getx yu have to make get
      themeMode: ThemeMode.system ,      //jo system ka mdoe hoga vo use ho jayega
      //about get pages  -->list of all pages its like mapping
      getPages: [
        GetPage(name: "/secondpage", page: ()=>SecondScreen()),
      ],
